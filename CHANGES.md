...
глав.
Вывод token counts в консоль можно отключить через
`logging.show_token_counts: false`; накопление в `state/token_usage.json` и
файловое логирование сохраняются.
